      ...
      <section id="services" class="services section-bg">
        <div class="container" data-aos="fade-up">
          <div class="section-title">
            <h2>Services</h2>
            <p>
              We provide creative, technical and business talent you need to
              succeed and web developers as a leading custom development company
              to assist startups and enterprises in creating smart solutions.
            </p>
          </div>
